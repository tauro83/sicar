...
function agregarValidacionesProducto(){
    ...
    if(varNombre){
        ...
        ValNombre.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
    }
    ...
    if(descripcion){
        ...
        ValDesc.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
    }
}
...
function agregarValidacionesConsultaFactura(){
   ...
   var codigo_kardex = document.getElementById("consulta_codigo_doc");
   if(codigo_kardex){
        codigo.setAttribute("maxlength","10");
        var ValCodigo_doc = new LiveValidation("consulta_codigo_doc",{validMessage: " ", wait: 500});
        ValCodigo_doc.add(Validate.Presence,{failureMessage: "Requerido"});
        ValCodigo_doc.add(Validate.Format,{pattern: /^\d{1,10}$/,failureMessage: "Ingrese un código válido"} );
   }
...
function disableSubmit(){$("#btn_submit_form").attr('disable','disable');}
//function to enable submit button
function enableSubmit(){$("#btn_submit_form").removeAttr('disable');}

function agregarValidacionesFactura(){
    var validacionesFact = new Array();
    var j=0;
    ...
    if(f_d){
        ...
        f_doc_codigo.add(Validate.Presence,{failureMessage: "Requerido"});
        f_doc_codigo.add(Validate.Format,{pattern: /^\d{1,10}$/,failureMessage: "El código debe tener de 1 a 10 dígitos"} );
        validacionesFact[j++] = f_doc_codigo;
    }

    var f_id = document.getElementById("cli_identificacion");
    if(f_id){
        f_id.setAttribute("maxlength","13");
        var f_identificacion = new LiveValidation("cli_identificacion",{validMessage: " ", wait: 500});
        ...
        f_identificacion.add(Validate.Format,{pattern: /(^\d{10}$|^\d{10}001$)/,failureMessage: "Ingrese un número de cédula o RUC"} );
         validacionesFact[j++] = f_identificacion;
}
...
function agregarValidacionesCliente(){
    var validacionesCliente = new Array();
    var j=0;
    ...
    if(f_id){
        ...
        validacionesCliente[j++] = f_identificacion;
    }
    ...
    if(f_n){
        ...
        f_nombre.add(Validate.Presence,{failureMessage: "Requerido"});
        f_nombre.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
        validacionesCliente[j++] = f_nombre;
    }
    ...
    if(f_a){
        ...
        f_apellido.add(Validate.Presence,{failureMessage: "Requerido"});
        f_apellido.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
        validacionesCliente[j++] = f_apellido;
    }
    ...
    if(f_s){
        ...
        f_direccion.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
        validacionesCliente[j++] = f_direccion;
    }
    ...
    if(f_c){
        ...
        f_celular.add(Validate.Format,{pattern: /^\d{9}$/,failureMessage: "Ingrese un celular válido"} );
        validacionesCliente[j++] = f_celular;
    }
    ...
    if(f_t){
        ...
        validacionesCliente[j++] = f_telefono;
    }
    ...
    if(f_cor){
        ...
        f_correo.add(Validate.Email,{failureMessage: "Ingrese un e-mail correcto"});
        f_correo.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\@)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\@)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
        validacionesCliente[j++] = f_correo;
    }
     return validacionesCliente;
}
...
function agregarValidacionesProveedor(){
    ...
    if(p_nombre){
        ...
        v_nombre.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
    }

    var p_ruc = document.getElementById("proveedor_prv_ruc");
    if(p_ruc){
        p_ruc.setAttribute("maxlength","13");
        var v_ruc = new LiveValidation("proveedor_prv_ruc",{validMessage: " ", wait: 500});
        v_ruc.add(Validate.Format,{pattern: /(^\d{10}001$)/,failureMessage: "Ingrese RUC válido"} );
    }
    ...
    if(p_direccion){
        ...
        v_direccion.add(Validate.Format,{pattern: /(^\w*[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\)))(\w*)]{0,}\w*[[(/)(\)( )(\.)(\-)(\_)(\ñ)(\#)(\,)(\()(\))(\w*)(\-)]{0,})$/,failureMessage:"Caracter inválido"});
    }

    var p_telefono = document.getElementById("proveedor_prv_telefono");
    if(p_telefono){
        p_telefono.setAttribute("maxlength","29");
        var v_telefono= new LiveValidation("proveedor_prv_telefono",{validMessage: " ", wait: 500});
        v_telefono.add(Validate.Format,{pattern: /^\d{9}$|^\d{9}(\-)\d{9}$|^\d{9}(\-)\d{9}(\-)\d{9}$/,failureMessage: "Ingrese un teléfono válido"} );
    }
...
function validarTodosLosCamposFactura(){
    var validations = agregarValidacionesFactura();
    var b =LiveValidation.massValidate(validations);
    return b;
}

function validarTodosLosCamposCliente(){
    var validations = agregarValidacionesCliente();
    var b =LiveValidation.massValidate(validations);
    return b;
}