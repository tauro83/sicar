         ...
         **************************************************/
            $(function(){
                $("#resultado_consulta_marca").jqGrid({
                    datatype: 'xmlstring',
                    datastr : "<?php echo preg_replace("[\n|\r|\n\r]", ' ', Cliente::xmlStringDataClientes($clientes)) ?>",
                    colNames:['Identificación','Cliente','Teléfono'],
                    colModel :[
                        {name:'nombre', index:'nombre', width:20, align:'center'},
                        {name:'direccion', index:'direccion', width:70, align:'center', sortable:false},
